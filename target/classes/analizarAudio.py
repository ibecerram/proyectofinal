...
general_path = '/home/user/Desktop/POO/Python/archive/Data'
lists = []

# Trim leading and trailing silence from an audio signal (silence before and after the actual audio)
#y, sr = librosa.load(f'{general_path}/genres_original/blues/blues.00002.wav')
filename = ntpath.basename('genres_original/stay.wav')

lists.append(filename)
lists.append(66149)
print('FILENAME: ', filename)

y, sr = librosa.load(f'{general_path}/genres_original/stay.wav')
...
with open("/home/user/Desktop/POO/Python/archive/Data/features_3_sec.csv", "a", newline='', encoding='utf-8') as fp:
